...
func (s *Status) SetFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&s.Feature, "feature", allFeatures, "Comma separated list of features to check")
	fs.StringVar(&s.Feature, "f", allFeatures, "Comma separated list of features to check")
