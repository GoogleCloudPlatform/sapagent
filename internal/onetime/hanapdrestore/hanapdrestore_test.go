...
func TestValidateParameters(t *testing.T) {
	tests := []struct {
		...
		{
			name: "InvalidNewDiskNameAutoGenerated",
			restorer: Restorer{
				project:        "my-project",
				sid:            "tst",
				hanaSidAdm:     "my-user",
				dataDiskName:   "disk-name-which-will-lead-to-longer-than-63-charecters",
				dataDiskZone:   "data-zone",
				sourceSnapshot: "snapshot",
				newDiskType:    "pd-ssd",
			},
...
func TestDefaultValues(t *testing.T) {
	...
	if !strings.HasPrefix(r.newdiskName, r.dataDiskName) {
		t.Errorf("newdiskName = %v, want = %v", r.newdiskName, "data-disk-name-<timestamp>")
	}
}
