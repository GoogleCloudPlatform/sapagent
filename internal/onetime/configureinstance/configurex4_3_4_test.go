...
func TestConfigureX43_4(t *testing.T) {
	tests := []struct {
		name    string
		c       ConfigureInstance
		want    bool
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got, gotErr := tc.c.configureX43_4(context.Background())
...
func TestConfigureX4SLES3_4(t *testing.T) {
	tests := []struct {
		name    string
		c       ConfigureInstance
		want    bool
		...
		},
		{
			...
			c: ConfigureInstance{
				ReadFile:    defaultReadFile([]error{nil, nil}, []string{"Name=SLES", string(googleX4Conf3_4)}),
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got, gotErr := tc.c.configureX4SLES3_4(context.Background())
			if !cmp.Equal(gotErr, tc.wantErr, cmpopts.EquateErrors()) {
...
func TestSaptuneService3_4(t *testing.T) {
	tests := []struct {
		name string
		c    ConfigureInstance
		want error
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := tc.c.saptuneService3_4(context.Background())
...
func TestSaptuneSolutions3_4(t *testing.T) {
	tests := []struct {
		name string
		c    ConfigureInstance
		want bool
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := tc.c.saptuneSolutions3_4(context.Background())
			if got != tc.want {
...
func TestSaptuneReapply3_4(t *testing.T) {
	tests := []struct {
		name           string
		sapTuneReapply bool
		c              ConfigureInstance
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			gotErr := tc.c.saptuneReapply3_4(context.Background(), tc.sapTuneReapply)
			if !cmp.Equal(gotErr, tc.wantErr, cmpopts.EquateErrors()) {
