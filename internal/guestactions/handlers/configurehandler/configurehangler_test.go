	...
	}{
		{
			...
			command: &gpb.AgentCommand{
				Parameters: map[string]string{
					...
					"path":                          "test_path",
					"skip_metrics":                  "test_skip_metrics",
					"validation_metrics_frequency":  "30",
					"db_frequency":                  "25",
					"fast_metrics_frequency":        "5",
					"slow_metrics_frequency":        "10",
		...
		},
		{
			...
			command: &gpb.AgentCommand{
				Parameters: map[string]string{
					"path":                         "test_path",
					"skip_metrics":                 "test_skip_metrics",
					"validation_metrics_frequency": "not a number",
					"db_frequency":                 "test bad data",
