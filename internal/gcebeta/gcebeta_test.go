...
func newTestService(ctx context.Context, responses []fakehttp.HardCodedResponse) (*GCEBeta, *httptest.Server, error) {
...
func TestGetInstance(t *testing.T) {
	...
	for _, tc := range tests {
		...
		defer s.Close()
		if err != nil {
			t.Fatalf("error constructing a GCEBeta client: %v", err)
		}
