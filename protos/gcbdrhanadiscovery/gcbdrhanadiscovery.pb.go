...
var file_gcbdrhanadiscovery_gcbdrhanadiscovery_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0x8e, 0x0a, 0x0a, 0x0b, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	...
	0x64, 0x69, 0x73, 0x6b, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x62, 0x06, 0x70,
...
var file_gcbdrhanadiscovery_gcbdrhanadiscovery_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcbdrhanadiscovery_gcbdrhanadiscovery_proto_goTypes = []interface{}{
	(*Application)(nil), // 0: sapagent.protos.gcbdrhanadiscovery.Application
	(*VolumePD)(nil),    // 1: sapagent.protos.gcbdrhanadiscovery.VolumePD
}
var file_gcbdrhanadiscovery_gcbdrhanadiscovery_proto_depIdxs = []int32{
	1, // 0: sapagent.protos.gcbdrhanadiscovery.Application.volume_details:type_name -> sapagent.protos.gcbdrhanadiscovery.VolumePD
...
func file_gcbdrhanadiscovery_gcbdrhanadiscovery_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_gcbdrhanadiscovery_gcbdrhanadiscovery_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gcbdrhanadiscovery_gcbdrhanadiscovery_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
