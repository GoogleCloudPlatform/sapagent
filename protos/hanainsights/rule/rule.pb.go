...
var file_hanainsights_rule_rule_proto_goTypes = []any{
...
func file_hanainsights_rule_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_hanainsights_rule_rule_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_hanainsights_rule_rule_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Query); i {
			case 0:
				return &v.state
			case 1:
		...
		file_hanainsights_rule_rule_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_hanainsights_rule_rule_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_hanainsights_rule_rule_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Action); i {
			case 0:
				return &v.state
			case 1:
