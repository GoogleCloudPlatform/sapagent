...
var file_hanamonitoringmigration_hanamonitoringmigration_proto_goTypes = []any{
...
func file_hanamonitoringmigration_hanamonitoringmigration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_hanamonitoringmigration_hanamonitoringmigration_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_hanamonitoringmigration_hanamonitoringmigration_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_hanamonitoringmigration_hanamonitoringmigration_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_hanamonitoringmigration_hanamonitoringmigration_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_hanamonitoringmigration_hanamonitoringmigration_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Query); i {
			case 0:
				return &v.state
			case 1:
		...
		file_hanamonitoringmigration_hanamonitoringmigration_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Column); i {
			case 0:
				return &v.state
			case 1:
