...
var file_datawarehouse_datawarehouse_proto_goTypes = []interface{}{
...
func file_datawarehouse_datawarehouse_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datawarehouse_datawarehouse_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_datawarehouse_datawarehouse_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_datawarehouse_datawarehouse_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_datawarehouse_datawarehouse_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
